  ...
  constructor() {
    super(
      ...
      },
      {
        ...
        // Home page specific
        home: {
          heroBadge: '✨ Revolutionary AI-Powered Shopping',
          heroTitle: 'Discover Premium Products with Intelligence',
          heroSubtitle: 'Experience next-generation shopping with our advanced AI recommendations, personalized experiences, and intelligent product discovery',
          shopNow: 'Start Shopping',
          viewAll: 'Explore All',
          freeShipping: 'Free Worldwide Shipping',
          freeShippingDesc: 'Complimentary delivery on all orders over $50 with real-time tracking',
          securePayment: 'Bank-Level Security',
          securePaymentDesc: 'Military-grade 256-bit SSL encryption with PCI DSS compliance',
          easyReturns: 'Hassle-Free Returns',
          easyReturnsDesc: '30-day money-back guarantee with prepaid return shipping',
          categoriesTitle: 'Shop by Premium Categories',
          categoriesSubtitle: 'Explore our curated collection of high-quality products across all categories',
          featuredProducts: 'Editor\'s Choice Selections',
          featuredProductsDesc: 'Discover our expert-curated selection of trending and premium products',
          aiRecommendations: 'AI-Powered Personalization',
          aiRecommendationsDesc: 'Receive intelligent product suggestions tailored to your unique preferences and shopping history',
          aiOptimizationTitle: 'Intelligent Product Optimization',
          aiOptimizationDesc: 'Our advanced AI continuously enhances product visibility, generates compelling descriptions, and maximizes search engine performance',
          averageSeoScore: 'AI SEO Optimization Score',
          seoScoreDesc: 'Real-time SEO performance metrics with AI-driven optimization recommendations',
          aiGeneratedCollections: 'Smart Product Collections',
          aiCollectionsDesc: 'AI-curated product groupings based on customer behavior, trends, and seasonal patterns',
          seoMonitoring: 'Advanced SEO Analytics',
          seoMonitoringDesc: 'Comprehensive performance monitoring with predictive analytics and optimization insights',
          ctaTitle: 'Ready to Transform Your Shopping Experience?',
          ctaSubtitle: 'Join thousands of discerning customers who trust our intelligent platform for premium shopping experiences.',
          startShopping: 'Begin Your Journey',
          learnMore: 'Discover More',
          exploreFeatures: 'Explore Features',
          customerReviews: 'Customer Reviews',
          trustIndicators: 'Trusted by Thousands'
        },
